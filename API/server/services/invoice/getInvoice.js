...
export default class InvoiceController {
    static getInvoice(id) {
        return DB("invoice")
            ...
            .select('invoice.id', 'invoice.status','invoice.createdon', 'workorder.createdon as workordercreatedon', 'payment.createdon as paymentcreatedon',  'workorder_id', 'invoice.client_id', 'invoice.discount',
