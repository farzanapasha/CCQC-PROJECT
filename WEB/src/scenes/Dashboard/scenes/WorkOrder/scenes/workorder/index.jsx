  ...
  render = () => {
    ...
    const columns = [
      {
        ...
        <Link 
                to={{
                  ...
                  {d.row.original.workOrderIdDisplay}
                  </Link>
          ...
          //     clientId: d.row.original.clientId,
          //     clientLocation: d.row.original.clientId,
      ...
      },
      {
        ...
        Cell: (d) => (
          <div
            // onClick={(e) => {
            //   this.props.openScheduleModel(d.row.original.workOrderId, d.row.original.workOrderIdDisplay, d.row.original.clientId);
          ...
          >
            {d.row.original.schedule.length <= 0 ? (
              ...
              // </div>
            ) : <span >{d.row.original.schedule[0].teamName}</span>}
          </div>
        ),
      },
      {
        ...
        Cell: (d) => (
          <div
            // onClick={(e) => {
            //   this.props.openInvoiceModel(d.row.original.workOrderId, d.row.original.workOrderIdDisplay, d.row.original.clientId);
          ...
          >
            {d.row.original.invoice.length <= 0 ? (
              // <div className="schedule-color">
              //   <i className="fas fa-history"></i>
                <span>No Invoice created</span>
              // </div>
            ) : <span >{d.row.original.invoice[0].invoice_idDisplay}</span>}
          </div>
        ),
      },
      {
    ...
    return (
      <div>
        ...
        {!this.props.openAddWorkOrder && !this.state.openEditWorkOrder && (
              ...
              <div>
                <div className="add-lead-block">
                  ...
                  <Select
                    ...
                    name="clientId"
                    value={_.find(ClientOption, { value: this.state.clientId })}
                    onChange={(e) => this.handleSelectChange("clientId", e)}
